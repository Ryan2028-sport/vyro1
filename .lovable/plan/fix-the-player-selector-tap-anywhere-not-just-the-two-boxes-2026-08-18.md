...
4. **Cleaner candidate frames.** Detection ignores the regions that cause the false markers: the crowd/banner band above the court and the score-bar strip at the bottom, plus blobs too small or too wide to be a body. Frames where the two detections are far apart _and_ differently coloured are still preferred.
