...
export function useLiveMetrics() {
  ...
  const { events, counts, connected, sessionState, ble, pairedId, pairedName, heartRateBpm, heartRateAt, batteryPct, restingHrBpm, hrvMs, respRateBrpm, stressScore } = ctx;
