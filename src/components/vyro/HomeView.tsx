  ...
  return (
    <div className="min-w-0 space-y-5 overflow-x-hidden">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <Card eyebrow="Top opportunity" title="Push intervals">
          <p className="text-xs leading-relaxed text-vyro-mute">
            Agility is peaking <span className="font-semibold text-vyro-mint">(+10.5% over 12 sessions)</span> — a good day to push interval ghosting.
          </p>
        </Card>
        <Card eyebrow="Top risk" title="Protect the corner">
          <p className="text-xs leading-relaxed text-vyro-mute">
            Muscle readiness still trails after long Z5 rallies. Keep corner-to-corner volume <span className="font-semibold text-vyro-amber">moderate</span>.
          </p>
        </Card>
      </div>
