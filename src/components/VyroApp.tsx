...
const VyroApp = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 font-sans selection:bg-[#007AFF]/10 overflow-x-hidden">
      {/* 1. ULTRA-SLIM COMPACT HEADER */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl border-b border-gray-100 px-6 flex justify-between items-center h-14">
      ...
      {/* 2. MAIN CONTENT */}
      <main className="px-6 pt-20 pb-32 max-w-lg mx-auto space-y-8">
    ...
    <div className="relative w-20 h-20 flex items-center justify-center">
      <svg className="absolute w-full h-full -rotate-90">
        ...
        <circle
          ...
          strokeDashoffset={213.6 - (213.6 * value) / 100}
          strokeLinecap="round"
        />
      </svg>
